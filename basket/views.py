...
def add_to_basket(request, item_id):
    ...
    if item_id in list(basket.keys()):
        ...
        basket[item_id] = quantity
        messages.success(request, f'Added {product.name} to your basket', extra_tags='basket')
...
def adjust_basket(request, item_id):
    ...
    if quantity > 0:
        ...
        basket.pop(item_id)
        messages.success(request, f'Removed {product.name} from your basket', extra_tags='basket')
